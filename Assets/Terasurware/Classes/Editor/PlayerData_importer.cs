...
public class PlayerData_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Resources/DataSet/PlayerData.xlsx";
	private static readonly string exportPath = "Assets/Resources/DataSet/PlayerData.asset";
	...
	static void OnPostprocessAllAssets (string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
	{
		foreach (string asset in importedAssets) {
			...
			Entity_PlayerData data = (Entity_PlayerData)AssetDatabase.LoadAssetAtPath (exportPath, typeof(Entity_PlayerData));
			if (data == null) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					Entity_PlayerData.Sheet s = new Entity_PlayerData.Sheet ();
					s.name = sheetName;
					...
					for (int i=1; i<= sheet.LastRowNum; i++) {
						...
						Entity_PlayerData.Param p = new Entity_PlayerData.Param ();
